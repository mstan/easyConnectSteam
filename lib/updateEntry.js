/* ==========================================================================
   ...
   updateEntry is an extension of the retrview system, in which the user
   can POST an update attempt to their entry. This also has an auth check
   for safety, as although our user cannot view the retrivew page if they
   aren't authenticated, a malicious user COULD try to splice some URLs
   together and bypass the page and force an entry anyway. This is a safety
