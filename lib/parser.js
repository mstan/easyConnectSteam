...
//Is this user authenticated? We don't want unregistered users claiming IPs
...
//Here's all of our variables for the database. Put them into one neat little array
  var passToDB = [ip, port, password, uniqueKey, createdOn, creator];

  req.db.run("INSERT INTO links (ip,port,password,uniqueKey,createdOn,creator) VALUES(?,?,?,?,?,?)", passToDB, function (err) {
